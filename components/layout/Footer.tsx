  ...
  return (
    <footer className="section-dark border-t border-white/8">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 text-sm text-on-dark">
            <div className="flex flex-col gap-2">
              <Eyebrow color="rgba(168,197,195,0.85)">Solutions</Eyebrow>
            ...
            <div className="flex flex-col gap-2">
              <Eyebrow color="rgba(168,197,195,0.85)">Resources</Eyebrow>
            ...
            <div className="flex flex-col gap-2">
              <Eyebrow color="rgba(168,197,195,0.85)">Legal</Eyebrow>
        ...
        <div className="mt-8 pt-6 border-t border-white/8 text-xs text-center" style={{ color: 'rgba(168,197,195,0.85)' }}>

        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          <div>
            ...
            <div className="flex gap-3 mt-3">
              <a href="https://www.linkedin.com/company/mlytics/" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center p-1.5 -ml-1.5 rounded-lg transition-colors hover:bg-white/10"
                style={{ color: '#A8C5C3' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 text-sm" style={{ color: '#A8C5C3' }}>
            <div className="flex flex-col gap-2">
              ...
              <Link href="/partnership" className="hover:text-white transition-colors" style={isActive('/partnership') ? { color: '#fff', fontWeight: 600 } : {}}>Media Partner Program</Link>
